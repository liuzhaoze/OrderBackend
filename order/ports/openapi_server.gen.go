...
type ServerInterface interface {
	...
	// (POST /customer/{customer_id}/create)
	PostCustomerCustomerIdCreate(c *gin.Context, customerId string)
...
// PostCustomerCustomerIdCreate operation middleware
func (siw *ServerInterfaceWrapper) PostCustomerCustomerIdCreate(c *gin.Context) {
	...
	siw.Handler.PostCustomerCustomerIdCreate(c, customerId)
}
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.POST(options.BaseURL+"/customer/:customer_id/create", wrapper.PostCustomerCustomerIdCreate)
